...
pixi run -e colmap ./VSLAM-Baselines/colmap/colmap_matcher.sh $sequence_path $exp_folder $exp_id $matcher_type $use_gpu
...
python VSLAM-Baselines/colmap/colmap_to_vslamlab.py $sequence_path $exp_folder $exp_id
